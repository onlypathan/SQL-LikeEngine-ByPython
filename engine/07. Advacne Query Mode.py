...
if st.session_state.advanced_mode:
    ...
    if "advanced_query_text" not in st.session_state:
        st.session_state.advanced_query_text = """# Example:
 db.select_query(
...
"""
    ...
    if st.button("🚀 Run Query"):
        try:
            # TODO: Implement actual advanced query execution here
            st.success("✅ Advanced query executed successfully!")
        except Exception as e:
            st.error(f"❌ Error: {e}")

    st.stop()  # ✅ Stop execution to hide normal builder UI
